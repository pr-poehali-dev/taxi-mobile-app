  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--dark-bg)" }}>
      ...
      <div className="relative overflow-hidden" style={{ paddingTop: "env(safe-area-inset-top, 12px)" }}>
        ...
        />
        <div
          className="absolute top-20 left-0 w-48 h-48 rounded-full opacity-10 pointer-events-none"
        ...
        <div className="mx-5 rounded-3xl overflow-hidden mb-5 relative" style={{ height: 200 }}>
          ...
          >
            ...
            <div
              className="absolute bottom-3 right-3 px-3 py-1.5 rounded-xl text-xs font-medium"
        ...
        <div className="px-5 mb-5">
          ...
          <div className="flex gap-2">
            {rideTypes.map((ride) => (
              ...
              >
                <div className="text-2xl mb-1">{ride.emoji}</div>
                <p className="text-xs font-semibold text-white">{ride.name}</p>
                <p className="text-xs mt-0.5" style={{ color: selectedRide === ride.id ? "#a855f7" : "rgba(255,255,255,0.4)" }}>
                  {ride.price}
                </p>
                <p className="text-xs" style={{ color: "rgba(255,255,255,0.3)" }}>{ride.time}</p>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="px-5 mb-6">
          <button
            className="w-full py-4 rounded-2xl font-bold text-white text-lg tracking-wide transition-all duration-200 active:scale-95"
            style={{
